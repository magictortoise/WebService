 ...
 * 
 */
@WebServiceClient(name = "StudentServiceImplService", targetNamespace = "http://service.example.com/", wsdlLocation = "http://localhost:8888/ws/student?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICEIMPLSERVICE_QNAME = new QName("http://service.example.com/", "StudentServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/ws/student?wsdl");
    ...
    public StudentService getStudentServiceImplPort() {
        return super.getPort(new QName("http://service.example.com/", "StudentServiceImplPort"), StudentService.class);
    }
    ...
    public StudentService getStudentServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.example.com/", "StudentServiceImplPort"), StudentService.class, features);
    }
